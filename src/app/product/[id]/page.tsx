...
const sampleProducts: Product[] = [
    ...
    },
    {
      ...
      rating: 5.0,
      itemText:["三層厚實 紙張柔軟細緻", "高效吸水減少用量, 環保水漂不添加螢光劑", "每張 0.17, 環保林木 FSC 認證紙漿", "支持森林保護守護地球", "不含螢光劑"],
      format:"100抽X 24包",
    },
    {
      id: "143950",
    ...
    },
    {
      ...
      rating: 5.0,
      itemText:["限定最高量洗淨成分", "可除衣領黃漬、醬油泥巴漬, 長效抗臭", "每顆 7.35, 10倍極淨力清除隔夜污漬", "99% 抗菌高效除螨, 洗衣槽防霉"],
      format:"53顆X 2袋入",
    },
    {
      id: "493577",
        ...
        <div className="max-w-4xl mx-auto p-4">
          <Card className="overflow-hidden">
            <div className="grid md:grid-cols-2 gap-6 p-6">
              ...
              {/* 產品特點 */}
                <ul className="space-y-2 mb-6">
                  {product.itemText.map((text, index) => (
